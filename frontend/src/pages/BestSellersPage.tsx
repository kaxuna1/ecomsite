    ...
    <div className="mx-auto max-w-7xl px-4 py-16">
      ...
      >
        {isLoading ? (
          ...
          <>
            Showing <span className="font-semibold text-[var(--color-primary)]">{filteredProducts.length}</span> best-selling{' '}
      ...
      {isLoading ? (
        ...
        <AnimatePresence mode="wait">
          {filteredProducts.length > 0 ? (
            ...
            >
              <FireIcon className="mx-auto h-16 w-16 text-[var(--color-text-tertiary)]" />
              <p className="mt-4 text-lg text-[var(--color-text-secondary)]">No best sellers found matching your criteria.</p>
              <motion.button
                type="button"
                onClick={() => {
                  setSearchQuery('');

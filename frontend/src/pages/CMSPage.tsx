...
export default function CMSPage() {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-bg-secondary/10">
        <div className="text-center">
          <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-primary mx-auto"></div>
          <p className="mt-4 text-text-primary/60 font-display uppercase tracking-wider text-sm">
            Loading...
          </p>
        </div>
      </div>
  ...
  if (error) {
    ...
    if (is404) {
      return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-bg-secondary/20 via-white to-primary/5">
          <div className="text-center px-4 py-12">
            <div className="mb-8">
              <h1 className="font-display text-9xl text-primary tracking-tight">404</h1>
            </div>
            <h2 className="text-4xl font-display text-text-primary mb-4 uppercase tracking-wide">
              Page Not Found
            </h2>
            ...
            <div className="flex gap-4 justify-center">
              ...
              <a
                href="/products"
                className="px-8 py-3 bg-white text-text-primary border-2 border-text-primary rounded-full hover:bg-text-primary hover:text-text-inverse transition-colors font-semibold shadow-lg"
              >
                Browse Products
              </a>
            </div>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-bg-secondary/10">
        <div className="text-center px-4 py-12 max-w-md">
          <h2 className="text-3xl font-display text-text-primary mb-4 uppercase tracking-wide">

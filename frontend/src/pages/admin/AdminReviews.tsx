    ...
    <>
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-4">
          <div className="bg-bg-elevated rounded-lg border border-border-default p-4">
          ...
          <div className="space-y-4">
            {reviews.map((review) => (
              ...
              >
                ...
                <div className="flex items-start justify-between mb-4">
                  ...
                  {review.productName && (
                    <div className="flex items-center gap-2 ml-4">
                      ...
                      <span className="text-sm text-text-primary">{review.productName}</span>
                    </div>
                  )}
                </div>
                ...
                {/* Review Text */}
                {review.reviewText && (
                  <p className="text-text-secondary mb-4">{review.reviewText}</p>
                )}
                ...
                {/* Admin Response */}
                {review.response && (
                  <div className="bg-bg-secondary border-l-4 border-primary/50 p-4 mb-4">
                    ...
                    <p className="text-sm text-text-secondary">{review.response.responseText}</p>
                  </div>
                )}
          ...
          <div className="flex items-center justify-between pt-6 border-t border-border-default">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                disabled={page === 1}
                className="px-4 py-2 text-sm font-medium text-text-primary bg-bg-secondary border border-border-default rounded-lg hover:bg-bg-elevated disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
                Previous
              </button>
        ...
        {showResponseModal && selectedReview && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-2 bg-bg-primary/80 backdrop-blur-sm sm:p-4"
            ...
            >
              ...
              <div className="mb-4">
                <label htmlFor="response-text" className="block text-sm font-medium text-text-primary mb-2">
                  Your Response
                </label>
                <textarea
                  id="response-text"
                  ...
                  rows={4}
                  className="w-full px-3 py-2 border border-border-default bg-bg-elevated rounded-lg text-text-primary focus:outline-none focus:ring-2 focus:ring-primary transition-colors"
              ...
              <div className="flex items-center justify-end gap-2">
                <button
                  ...
                  className="px-4 py-2 text-sm font-medium text-text-primary bg-bg-secondary border border-border-default rounded-lg hover:bg-bg-elevated transition-colors"
                >
                  Cancel
                </button>
                <button

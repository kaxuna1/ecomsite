            ...
            <AnimatePresence mode="popLayout">
              ...
              >
                ...
                <div className="p-6 space-y-4">
                  ...
                  {/* Actions */}
                  <div className="space-y-2 pt-2 border-t border-border-default overflow-hidden">
                    {/* Primary Actions Row */}
                    <div className="flex flex-wrap gap-2 min-w-0">
                      {!theme.isActive && (
                        <button
                          ...
                          className="flex-1 md:flex-none flex items-center justify-center gap-1 md:gap-2 px-2 md:px-3 py-2 bg-emerald-500/20 text-emerald-400 border border-emerald-500/30 rounded-lg hover:bg-emerald-500/30 transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-xs md:text-sm font-medium"
                      ...
                      <button
                        ...
                        className="flex-1 md:flex-none flex items-center justify-center gap-1 md:gap-2 px-2 md:px-3 py-2 bg-bg-secondary text-text-primary border border-border-default rounded-lg hover:bg-bg-elevated transition-colors text-xs md:text-sm font-medium"
                        title="Preview theme"
                      >
                      ...
                      {theme.isActive && (
                        <button
                          ...
                          className="flex-1 md:flex-none flex items-center justify-center gap-1 md:gap-2 px-2 md:px-3 py-2 bg-primary/20 text-primary border border-primary/30 rounded-lg hover:bg-interactive-default/30 transition-colors text-xs md:text-sm font-medium"
                          title="Edit theme"
                        >
                      ...
                      {!theme.isActive && !theme.isSystemTheme && (
                        <button
                          ...
                          className="px-2 md:px-4 py-2 bg-rose-500/20 text-rose-400 border border-rose-500/30 rounded-lg hover:bg-rose-500/30 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex-shrink-0"
                          title="Delete theme"
                        >
                    ...
                    <div className="flex flex-wrap gap-2 min-w-0">
                      <button
                        ...
                        className="flex-1 md:flex-none flex items-center justify-center gap-1 md:gap-2 px-2 md:px-3 py-2 bg-blue-500/10 text-blue-400 border border-blue-500/20 rounded-lg hover:bg-blue-500/20 transition-colors text-xs md:text-sm"
                      ...
                      <button
                        ...
                        className="flex-1 md:flex-none flex items-center justify-center gap-1 md:gap-2 px-2 md:px-3 py-2 bg-purple-500/10 text-purple-400 border border-purple-500/20 rounded-lg hover:bg-purple-500/20 transition-colors text-xs md:text-sm"

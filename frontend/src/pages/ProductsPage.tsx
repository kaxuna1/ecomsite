    ...
    <div className="mx-auto max-w-7xl px-4 py-16">
      ...
      <motion.header className="space-y-6 text-center" {...fadeInUp}>
        <div className="space-y-4">
          ...
          <p className="mx-auto max-w-2xl text-base text-midnight/70">{t('products.description')}</p>
        </div>
      ...
      >
        ...
        <div className="flex flex-wrap items-center gap-2">
          <AdjustmentsHorizontalIcon className="h-5 w-5 text-midnight/40" />
          <motion.button
            type="button"
      ...
      >
        {isLoading ? (
          ...
          <>
            Showing <span className="font-semibold text-jade">{filteredProducts.length}</span> of{' '}
      ...
      {isLoading ? (
        ...
        <AnimatePresence mode="wait">
          {filteredProducts.length > 0 ? (
            ...
            >
              <p className="text-lg text-midnight/60">No products found matching your criteria.</p>
              <motion.button
                type="button"
                onClick={() => {
                  setSearchQuery('');

    ...
    <div className="min-h-screen bg-gradient-to-br from-bg-secondary/30 via-white to-blush/20 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="font-display text-2xl text-text-primary mb-2 sm:text-3xl lg:text-4xl">{t('signup.title')}</h2>
        ...
        >
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full bg-primary text-on-primary py-3 rounded-xl font-semibold shadow-lg hover:bg-primary/90 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {isLoading ? (
                <>
                  <motion.div
